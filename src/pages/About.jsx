...
export const About = () => {
  return (
    ...
    <div className="px-16 mt-6">
                                    ...
                                    <p className="text-gray-600 text-center pt-3 font-normal text-wrap">Welcome to our haven of conscientious commerce, where every transaction tells a story of passion, purpose, and profound respect for our planet. Founded with a heartfelt commitment to sustainability and environmental stewardship, our journey began with a deeply personal revelation.
